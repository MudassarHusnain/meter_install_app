...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference("Division.count") do
      post divisions_url, params: { division: { name: @division.name, region_id: @division.region_id } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { name: @division.name, region_id: @division.region_id } }
